...
Now that you have a familiarity with Linx, let's get familiar with R. R is a powerful statistical computing language with great data visualiztion tools. And as such it is a favorite of bioinformaticians. We will break this workshop into XXX parts: R/RStudio, Snytax/Data Structures, Importing Data, and Manipulating Data.
